        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: MaterialButton(
                  onPressed: () {
                    CacheHelper().saveData(key: ApiKey.type, value: "");
                    CacheHelper().saveData(key: ApiKey.token, value: "");
                    CacheHelper().saveData(key: ApiKey.name, value: "");
                    CacheHelper().saveData(key: ApiKey.phone, value: "");
                    CacheHelper().saveData(key: ApiKey.image, value: "");
                    CacheHelper().saveData(key: ApiKey.id, value: "");
